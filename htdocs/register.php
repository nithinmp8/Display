...
move_uploaded_file($_FILES['avatar']['tmp_name'], $location);
 ...
 if(mysqli_num_rows($result0)==0){
    $result= mysqli_query($db,"INSERT INTO register(firstname,lastname,email,password,gender,avatar) VALUES ('$firstname','$lastname','$email','$password','$gender','$location')") or die(mysqli_error($db));
      $_SESSION['mail']=$email;
